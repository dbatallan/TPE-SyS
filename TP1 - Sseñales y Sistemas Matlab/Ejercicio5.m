...
audiowrite('Ejercicio5_error_estaba_la.wav',y-pista,44100);
...
figure
hold on
    title("Gráfico de la señal error estaba\_la.wav")
    ...
    saveas(f,'Ejercicio5_grafico_temporal_error.svg','svg')
hold off
